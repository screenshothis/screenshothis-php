...
class TakeScreenshotResponse
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?string $twoHundredImageJpegBytes = null, ?string $twoHundredImagePngBytes = null, ?string $twoHundredImageWebpBytes = null)
    {
